...
import studentsImg from '../assets/strengths/students.png';
import teachersImg from '../assets/strengths/teachers.png';
import academicImg from '../assets/strengths/academic.png';
import legacyImg from '../assets/strengths/legacy.png';
        ...
        <section className="strength-section">
            ...
            <div className="strength-grid">
                {strengths.map((item, index) => (
                    <div key={index} className="strength-item card-vibe">
                        <div className="strength-card-bg">
                            <img src={item.image} alt="" className="strength-bg-img" />
                            <div className="strength-bg-overlay"></div>
                        </div>
