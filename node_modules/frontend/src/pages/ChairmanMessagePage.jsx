            ...
            <section className="chairman-main-content reveal-on-scroll">
                ...
                <div className="chairman-detailed-text">
                    ...
                    <div className="message-body">
                        ...
                        <p>
                            <strong>शंभू परशाद</strong> और <strong>फूल मती</strong> के महान विजन से शुरू हुई यह संस्था 
                            आज अपनी सफलता के 15 गौरवशाली वर्ष पूरे कर चुकी है। पिछले 1.5 दशक से हम निरंतर अपने शिक्षण के तरीकों और बुनियादी ढांचे (Infrastructure) 
                            को आधुनिक बना रहे हैं। स्मार्ट क्लासेज और डिजिटल पोर्टल हमारे इसी प्रयास का हिस्सा हैं।
                        </p>
                        <p>
                            मैं सभी अभिभावकों का आभार व्यक्त करता हूँ जिन्होंने पिछले 15 वर्षों से हम पर विश्वास किया। 
                            हम साथ मिलकर अपने बच्चों के भविष्य को और भी उज्जवल बनाएंगे।
                        </p>
                    </div>
